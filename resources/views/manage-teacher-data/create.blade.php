...
<div class="col-lg-8">
    <form method="post" action="{{ route('manage-teacher-data.store') }}" class="mb-5" enctype="multipart/form-data">
        @csrf
        <input type="hidden" >
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        {{-- <div class="mb-3">
            ...
            <label class="custom-switch">
                <input type="radio" name="is_admin" value="1" class="custom-switch-input">
                <span class="custom-switch-indicator"></span>
                <span class="custom-switch-description">Ya</span>
                <input type="radio" name="is_admin" value="0" class="custom-switch-input">
                <span class="custom-switch-indicator"></span>
